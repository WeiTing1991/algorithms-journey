...
def binary_search(num_list, num_to_find):
    ...
    while left_index <= right_index:
        ...
        if mid_number == num_to_find:
            return mid_index
        if mid_number < num_to_find:    # this means number is in right hand side of the list
...
if __name__ == '__main__':
    ...
    index_b_r = binary_search_recursive(numbers_list, number_to_find, 0, len(numbers_list))
    print(index_b_r, "\n")
